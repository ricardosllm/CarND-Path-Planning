...
int helper::ClosestWaypoint(double x, double y,
                            vector<double> maps_x,
                            vector<double> maps_y)
{
...
int helper::NextWaypoint(double x, double y,
                         double theta,
                         vector<double> maps_x,
                         vector<double> maps_y)
{
...
vector<double> helper::getXY(double s, double d,
...
void helper::updateGraphFromFile(double value){
...
void helper::plot(vector<vector<double> > &data){
...
void helper::plot(vector<double> &x , vector<double> &y, char const* color){
...
void helper::twoPlot(vector<double> &x ,
                     vector<double> &y,
                     char const* color,
                     vector<double> &x1 ,
                     vector<double> &y1,
